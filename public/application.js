...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://share-n-play.herokuapp.com',
...
var toyEvents = __webpack_require__(15);
var imageEvents = __webpack_require__(36);
...
var signOutFailureure = function signOutFailureure(response) {
  clearFields();
  $('#successModal').modal('show');
  $('#content-msg').html('');
...
module.exports = {
  ...
  signOutFailureure: signOutFailureure,
...
var getFormFields = __webpack_require__(4);
var toysUi = __webpack_require__(16);
var toysApi = __webpack_require__(35);
// const usersToysUi = require('../usersToys/ui.js')
// Data: A plain object or string that is sent to the server with the request.
//

var onCreateToy = function onCreateToy(event) {
  ...
  .then(toysUi.createToySuccess).catch(toysUi.createToyError);
};
...
var onGetToys = function onGetToys() {
  // toysUi.resetUiHandleing()
  toysApi.getToys().then(toysUi.getToysSuccess).catch(toysUi.getToysError);
};

var refreshToysOnDelete = function refreshToysOnDelete(event) {
  $('#content-msg').html('');
  toysApi.getToys().then(toysUi.deleteToySuccess);
};

var onDeleteToy = function onDeleteToy(event) {
  event.preventDefault();
  // toyUi.resetUiHandleing()
  var toyId = $(event.target).attr('data-id');
  toysApi.deleteToy(toyId).then(refreshToysOnDelete).catch(toysUi.deleteToyError);
};

var onGetUserToys = function onGetUserToys(event) {
  // const data = getFormFields(event.target)
  event.preventDefault();
  toysApi.getToys().then(toysUi.getUserToysSuccess).catch(toysUi.getUserToysError);
...
var refreshToys = function refreshToys(event) {
  $('#content-msg').html('');
  toysApi.getToys().then(toysUi.getUserToysSuccess).catch();
};

var onUpdateToy = function onUpdateToy(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var toyId = $(event.target).attr('data-id');
  $('.modal-backdrop').remove();
  toysApi.updateToy(data, toyId).then(toysUi.updateToySuccess).catch(toysUi.updateToyError);
};

var onRequestShare = function onRequestShare(event) {
  var toyId = $(event.target).attr('data-id');
  toysApi.requestShare(toyId).then(toysUi.requestShareSuccess).catch(toysUi.requestShareError);
};

var refreshToysOnRequest = function refreshToysOnRequest(event) {
  $('#content-msg').html('');
  toysApi.getToys().then(toysUi.requestToySuccess);
};
...
module.exports = {
  ...
  onGetUserToys: onGetUserToys,
  addHandlers: addHandlers,
  onOpenUpdateModal: onOpenUpdateModal,
  onRequestShare: onRequestShare,
  refreshToysOnDelete: refreshToysOnDelete,
  refreshToysOnRequest: refreshToysOnRequest,
  refreshToys: refreshToys
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var store = __webpack_require__(2);
var showToysTemplate = __webpack_require__(17);
var showUserToyTemplate = __webpack_require__(34);
...
var createToySuccess = function createToySuccess(data) {
  store.toy = {};
...
var createToyError = function createToyError() {
...
var getUserToysSuccess = function getUserToysSuccess(data) {
  store.toys = data.toys;
  var userToys = [];
  for (var i = 0; data.toys.length > i; i++) {
  ...
  if (userToys.length > 0) {
    var showUserToys = showUserToyTemplate({
      toys: userToys
    });
    $('#successModal').modal('show');
...
var getToysSuccess = function getToysSuccess(data) {
  store.toys = data.toys;
  var allToys = [];
  for (var i = 0; data.toys.length > i; i++) {
  ...
  if (allToys.length > 0) {
    var showAllToys = showToysTemplate({
      toys: allToys
    });
    $('.modal-backdrop').remove();
...
var deleteToySuccess = function deleteToySuccess() {
  $('.modal-backdrop').remove();
  $('#successModal').modal('show');
...
var updateToySuccess = function updateToySuccess(toyId) {
  clearFields();
  $('#content-msg').html('');
  $('.modal-backdrop').remove();
  $('#successModal').modal('show');
...
var requestShareSuccess = function requestShareSuccess(toyId) {
  $('.modal-backdrop').remove();
  clearFields();
  $('#content-msg').html('');
  $('#successModal').modal('show');
...
module.exports = {
  createToySuccess: createToySuccess,
  createToyError: createToyError,
  getToysSuccess: getToysSuccess,
  deleteToySuccess: deleteToySuccess,
  updateToySuccess: updateToySuccess,
  getUserToysSuccess: getUserToysSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div id=\"view-all-toys-handlebars\" class=\"card\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n\n    <div class=\"card-body col-sm-2 col-med-2\" data-id= =\"card"
    + alias2(((helper = (helper = helpers["toy-id"] || (depth0 != null ? depth0["toy-id"] : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"toy-id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "\" style=\"background-color: #66ffff; border-color: red; width: 30.5%; min-height: 300px; margin: 10px; padding-top: 20px;\">\n      <div class=\"show-options col-xs-12 delete-toy\">\n    <h5>Name:"
    ...
    + "</h5>\n\n    <button type=\"button pull-right\" data-toggle=\"modal\" data-target= '#"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'  data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"shareToyButton btn btn-primary\">I want this toy !!</button>\n\n      </div>\n    </div>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.toys : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div id=\"view-user-toys-handlebars\" class=\"card\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"card-body col-sm-2 col-med-2\" style=\"background-color: #66ffff; border-color: red; width: 30.5%; min-height: 300px; margin: 10px; padding-top: 20px;\">\n      <div class=\"show-options col-xs-12 response-message\">\n    <h5>Name:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h5> <h5>Description:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "</h5>\n    <!-- <h5>Are you sharing this at the moment?:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.is_available : stack1), depth0))
    + "</h5> -->\n\n    <button type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"updateButton btn btn-primary\">Update Toy</button>\n    <button type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"deleteButton btn btn-primary\">Delete Toy</button>\n\n<!-- update toy modal below -->\n<div class=\"modal fade updateModal\" data-id=\"modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title toyUpdateTitle\">Update Toy</h5>\n\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n\n            </div>\n\n            <div class=\"modal-body\">\n              <form class=\"update-form\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                 <div class=\"form-group\">\n                  <label for=\"formGroupExampleInput\">Name</label>\n                  <input name = \"toy[name]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" required class=\"form-control\">\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"formGroupExampleInput2\">Description</label>\n                  <input  name =\"toy[description]\" class=\"form-control\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" required value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "\"></input>\n                </div>\n\n                 <div class=\"form-group\">\n\n                <div class=\"form-group\">\n                  <h5><label for=\"formGroupExampleInput2\">Do you want to share your toy???</label></br>\n\n                    <input type=\"radio\" name=\"toy[is_available]\" value=\"true\" required><b>&nbsp;Share</b></h5>\n                  <h5><input type=\"radio\" name=\"toy[is_available]\" value=\"false\"><b>&nbsp;Dont'Share</b></h5>\n                </div>\n\n                <div class=\"modal-footer\">\n\n                  <button type=\"submit\" data-id=\""
  ...
  return "</br>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.toys : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var createToy = function createToy(data) {
...
var deleteToy = function deleteToy(toyId) {
  return $.ajax({
    method: 'DELETE',
...
var updateToy = function updateToy(data, toyId) {
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + '/toys/' + toyId,
    data: data,
...
var requestShare = function requestShare(toyId) {
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + '/toys/' + toyId,
    data: {
...
var getFormFields = __webpack_require__(4);
var ImageUi = __webpack_require__(37);
var ImageApi = __webpack_require__(38);
...
var onUploadImage = function onUploadImage(event) {
  ...
  // console.log(`data is`, data)
  .then(ImageUi.uploadImageSuccess).catch(ImageUi.uploadImageError);
};
...
var uploadImageSuccess = function uploadImageSuccess(data) {
  // store.image = {}
  // store.toy.id = data.toy.id
  // $('#createItemModal').modal('hide')
  // $('#create-item-form').reset()
...
var uploadImageError = function uploadImageError() {
  // $('#createModalLabel').css('color', 'red')
  // $('#createModalLabel').html('Something went wrong creating item try again!')
  // clearFields()
  // $('#successModal').modal('show')
